...
import { Menu, X, Send, Globe, Info, Mail, Home } from 'lucide-react';
...
export default function Header() {
  ...
  const menuItems = [
    ...
    { id: 'countries', label: 'انتخاب کشور', labelEn: 'Countries', icon: Globe, href: '/mail' },
    { id: 'why', label: 'چرا مهم است', labelEn: 'Why It Matters', icon: Info, href: '/iranvoice' },
    { id: 'contact', label: 'تماس با ما', labelEn: 'Contact', icon: Mail, href: '/contact' },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span style={{ fontFamily: 'Vazirmatn, sans-serif' }}>{item.label}</span>
                    </div>
            ...
            >
              ...
              <span style={{ fontFamily: 'Vazirmatn, sans-serif' }}>ارسال نامه</span>
            </motion.button>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p style={{ fontFamily: 'Vazirmatn, sans-serif' }}>{item.label}</p>
